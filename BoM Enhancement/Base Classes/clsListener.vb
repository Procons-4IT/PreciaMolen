        ...
        Try
            If pVal.BeforeAction = False Then
                Select Case pVal.MenuUID
                    ...
                    Case mnu_Phase
                        oMenuObject = New clsPhase
                        oMenuObject.MenuEvent(pVal, BubbleEvent)
                    Case mnu_Seq
                        oMenuObject = New clsSequence
                        oMenuObject.MenuEvent(pVal, BubbleEvent)
        ...
        Try
            Select Case EventType
                Case SAPbouiCOM.BoAppEventTypes.aet_ShutDown, SAPbouiCOM.BoAppEventTypes.aet_ServerTerminition, SAPbouiCOM.BoAppEventTypes.aet_CompanyChanged
                    ...
                    oApplication.Utilities.Message("BoM Addon Disconnected successfully", SAPbouiCOM.BoStatusBarMessageType.smt_Success)
                    CloseApp()
            End Select
        Catch ex As Exception
...
#End Region
    ...
    Private Sub _SBO_Application_RightClickEvent(ByRef eventInfo As SAPbouiCOM.ContextMenuInfo, ByRef BubbleEvent As Boolean) Handles _SBO_Application.RightClickEvent
        ...
        Try
            ...
            If oForm.TypeEx = frm_BoM Or oForm.TypeEx = frm_ProductionOrder Then
    ...
    Private Sub _SBO_Application_PrintEvent(ByRef eventInfo As SAPbouiCOM.PrintEventInfo, ByRef BubbleEvent As Boolean) Handles _SBO_Application.PrintEvent
